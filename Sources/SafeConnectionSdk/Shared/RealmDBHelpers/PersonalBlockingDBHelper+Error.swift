//
//  PersonalBlockingDBHelper+Error.swift
//  Merli
//
...
extension PersonalBlockingDBHelper {
    struct Error: WSCError {
        typealias InternalErrorEnum = ErrorEnum

        static let errorDomain = "com.starhub.scambuster.personalblockingdbhelper.error"
        ...
        enum ErrorEnum: LocalizedError {
            ...
            var errorDescription: String? {
                ...
                case .reachedLimit:
                    return "Reached number-blocking limit (\(PersonalBlockingDBHelper.maxBlockingAmount) numbers)"
                case .entryNotFound:
